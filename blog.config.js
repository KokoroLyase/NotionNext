...
const BLOG = {
  ...
  NOTION_PAGE_ID:
    ...
    '2c5b5947441581379711e2941654b79e',
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'KokoroLyase', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一只可爱的小猫猫~', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://blog.kokorolyase.top', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'KokoroLyase, 欣玫, blog, 博客', // 网站关键词 英文逗号隔开
  BLOG_FAVICON: process.env.NEXT_PUBLIC_FAVICON || '/favicon.ico', // blog favicon 配置, 默认使用 /public/favicon.ico，支持在线图片，如 https://img.imesong.com/favicon.png
  BEI_AN: process.env.NEXT_PUBLIC_BEI_AN || '萌ICP备20251301号', // 备案号 闽ICP备XXXXXX
  BEI_AN_LINK: process.env.NEXT_PUBLIC_BEI_AN_LINK || 'https://icp.gov.moe/?keyword=20251301', // 备案查询链接，如果用了萌备等备案请在这里填写
  ...
  GREETING_WORDS:
    ...
    'Hi，我是KokoroLyase, Hi，我是欣玫,Hi，我是一只可爱的小猫猫,欢迎来到我的博客🎉',
